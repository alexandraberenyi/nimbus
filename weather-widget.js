...
.then(z=>z.file(/./)[0].async("text"))
    .then(d=>{
            ...
            if (jelenido == 1)  {
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/derult.jpeg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Varga Ákos";
            }else if (jelenido == 2) {
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/kissefelhos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
            }else if (jelenido == 3) {
                document.getElementById("jelenido").innerHTML =  " közepesen felhős";
                jelenimg.classList.remove("wi-day-sunny");
                jelenimg.classList.add("wi-day-cloudy");
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/kozepesenfelhos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/erosenfelhos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/borult.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Varga Ákos";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/fatyolfelhos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/kodos.JPG)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Varga Ákos";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/parassag.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Hérincs Dávid";
            }else if (jelenido == 10) {
                document.getElementById("jelenido").innerHTML = " közepesen felhős, párás";
                jelenimg.classList.remove("wi-day-sunny");
                jelenimg.classList.add("wi-day-fog");
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/paras2.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/erosenfatyolfelhos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/esos.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
                ...
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása:";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
            }else if (jelenido == 103) {
                document.getElementById("jelenido").innerHTML = " zápor",
                jelenimg.classList.remove("wi-day-sunny");
                jelenimg.classList.add("wi-day-shower");
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/zapor.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Varga Ákos";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/zivatar.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Hérincs Dávid";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/havas.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Hérincs Dávid";
                ...
                document.getElementById("widgetImageId").style.background = "url(nimbus/media/main_jelen/eroseso.jpg)"
                document.getElementById("widgetImageId").style.backgroundAttachment = "fixed";
                document.getElementById("widgetImageId").style.backgroundPosition = "bottom center";
                document.getElementById("widgetImageId").style.backgroundSize = "cover";
                document.getElementById("imageSource").innerHTML = " Kép forrása: Henzel Dániel";
